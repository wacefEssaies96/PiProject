                ...
                <div className="newsletter">
                  ...
                  >
                    <div className="textwidget custom-html-widget">
                      <form
                        id="mc4wp-form-1"
                        className="mc4wp-form mc4wp-form-468"
                        method="post"
                        data-id="468"
                        data-name="Subscribe"
                      >
                        <div className="mc4wp-form-fields">
                          ...
                          <button type="button" defaultValue="Sign up">
              ...
              <div className="widget_inner">
                ...
                >
                  ...
                  <div className="textwidget custom-html-widget">
                    <p>Our Address</p>
                    <p>
                      E: <a href="#">health.spotLight@gmail.com</a>
                    </p>
                    <p>P: +216</p>
                  </div>
                </div>{' '}
            ...
            <div className="col-lg-4 footer_widget">
              <div className="widget_inner">
                <div id="nav_menu-2" className="widget widget_nav_menu">
                  <h4 className="widget-title">Other Pages</h4>
                  <div className="menu-footer-menu-2-container">
                    <ul id="menu-footer-menu-2" className="menu">
                      <li
                        id="menu-item-1763"
                        className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1763"
                      >
                        <a href="#">Contact Us</a>
                      </li>
                      <li
                      ...
                      <li
                        id="menu-item-1765"
                        className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1765"
                      >
            ...
            <div className="row">
              <div className="col-lg-5">
                <div className="footer-copyright-text">
                  <p>© 2023 Health SpotLight All Rights Reserved </p>
                </div>
              </div>
                  ...
                  <div id="nav_menu-3" className="widget widget_nav_menu">
                    <div className="menu-footer-bottom-menu-container">
                      <ul id="menu-footer-bottom-menu" className="menu">
                        <li
                          id="menu-item-1742"
                          className="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-148 current_page_item menu-item-1742"
                        >
                        ...
                        <li
                          id="menu-item-1772"
                          className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1772"
                        >
                          <a href="#">About us</a>
                        </li>
                        <li
