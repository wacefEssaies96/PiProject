...
function Header() {
  ...
  const getNotifications = async () => {
    const response = await axios.get(
      `${process.env.backurl}/api/notifications/find/${cookies.get('user')._id}`
    );
                ...
                <ul>
                  ...
                  <li className="has-dropdown">
                    {!newNotif ? (
                      ...
                      <a href="#" onMouseLeave={() => setNewNotif(false)}>
                        <i
                          className="fa fa-bell-o new-notif"
                          aria-hidden="true"
                        ></i>
                      </a>
                    )}
                ...
                <div className="nav">
                  <nav>
                    <ul id="menu-main-menu" className="menu">
                          ...
                          >
                            ...
                            <ul className="sub-menu">
                              ...
                              <li
                                ...
                                className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1768"
                              >
                                <Link href="/admin/sport-sub-type">
                                  Sport Sub Types
                                </Link>
                              </li>
                              <li
                              ...
                              >
                                <Link href="/admin/event-calendar-sports">
                                  Event Calendar for Sports
                                </Link>
                              </li>
                              <li
                                id="menu-item-1769"
                                className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1769"
                              >
                                <Link href="/admin/sport-progress">
                                  List of Sport Progress
                                </Link>
                              </li>
                            </ul>
                          </li>
                      ...
                      >
                        ...
                        <ul className="sub-menu">
                          ...
                          <li
                            ...
                            className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1753"
                          >
                            <Link href="/sport-types">Sport Types</Link>
                          </li>
                          <li
                            id="menu-item-1768"
                            className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1768"
                          >
                            <Link href="/sub-sport-types">Sport SubTypes</Link>
                          </li>
                          {auth.user != undefined &&
                            auth.user.hasOwnProperty('subTypeSport') && (
                              <li
                                id="menu-item-1768"
                                className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1768"
                              >
                                <Link
                                  href={`/sports/sport-videos/${auth.user._id}`}
                                >
                                  Training Videos
                                </Link>
                              </li>
                          ...
                          {auth.user && (
                            <li
                              ...
                              className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1769"
                            >
                              <Link href={`/sports/videos/${auth.user._id}`}>
                                Sport Videos
                              </Link>
                            </li>
                          )}
                          {auth.user && (
                            <li
                              ...
                              className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1769"
                            >
                              <Link href={`/sports/calendar/${auth.user._id}`}>
                                Sport Calendar Plan
                              </Link>
                            </li>
                          )}
                        ...
                        <ul className="sub-menu">
                          ...
                          {auth.user != null && (
                            <li
                              ...
                              className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1768"
                            >
                              <Link href="/articles/my-articles">
                                My articles
                              </Link>
                            </li>
                          )}
                      ...
                      <li
                        id="menu-item-1728"
                        className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1728"
                      >
                        <a href="#">Products</a>
                        <ul className="sub-menu">
                          <li
                      ...
                      <li
                        id="menu-item-1719"
                        className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1719"
                      >
                        <a href="#">Pages</a>
                        <ul className="sub-menu">
                          <li
