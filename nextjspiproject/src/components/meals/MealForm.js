      ...
      >
        <Stack gap={4}>
          <Form.Group>
            ...
            <Form.Control
              defaultValue={meal.FoodCategory}
          ...
          <Form.Group>
            ...
            <Form.Control
              defaultValue={meal.calories_100g}
              placeholder="150"
              type="text"
              id="calories_100g"
              name="calories_100g"
          ...
          <Form.Group>
            <Form.Label htmlFor="serving_size_portion">
              {' '}
              Serving Size Portion{' '}
            </Form.Label>
            <Form.Control
              defaultValue={meal.serving_size_portion}
              placeholder="10"
              type="text"
              id="serving_size_portion"
              name="serving_size_portion"
              required
            ></Form.Control>
          </Form.Group>
          ...
          <Form.Group>
            ...
            <Form.Control
              defaultValue={meal.serving_size_oz}
              placeholder="28"
              type="text"
              id="serving_size_oz"
