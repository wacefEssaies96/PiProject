                            ...
                            <div className="offset-lg-3 col-lg-6  mx-auto d-block login-page">
                                ...
                                <Form noValidate validated={validated} onSubmit={handleSubmit} className="form-horizontal registraion-form">
                                    ...
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control id="vb_name" defaultValue={doctor.fullname} name="fullName" type="text" placeholder="FullName" required minLength={4} maxLength={15} />
                                    ...
                                    <Form.Label>Gender</Form.Label>
                                        <div className="mb-3">
                                            <Form.Select className="form-control" defaultValue={doctor.gender} name="gender" aria-label="Default select example" required>
                                        ...
                                        <div className="mb-3">
                                            <Form.Select className="form-control" defaultValue={doctor.speciality} name="speciality" aria-label="Default select example" required>
